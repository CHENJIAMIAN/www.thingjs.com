...
panel.addNumberSlider(config, "mosaicSize").caption("马赛克尺寸").min(1).max(20).isChangeValue(true).on("change", function (v) {
...
panel.addNumberSlider(config, "opacity").caption("透明度").step(0.01).min(0).max(1.0).isChangeValue(true).on("change", function (v) {
