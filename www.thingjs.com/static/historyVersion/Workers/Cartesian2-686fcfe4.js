...
define(['exports', './when-54c2dc71', './Check-6c0211bc', './Math-fc8cecf5'], function (exports, when, Check, _Math) { 'use strict';
   ...
   * 6378000 为了兼顾Uearth中的坐标计算，将球半径做修改
   * @type {Ellipsoid}
   * @constant
   */
  Ellipsoid.WGS84 = Object.freeze(
    // begin changed by zhangtengfei
    new Ellipsoid(6378137.0, 6378137.0, 6356752.3142451793)
    // new Ellipsoid(6378000.0, 6378000.0, 6378000.0)
    // end changed by zhangtengfei
  );
